...
PaginationDtoOut<TaxRule> result =shippingTaxUseCase.findAllTaxRules(page,size,sortBy,ascending);
return ResponseEntity.ok(PaginationMapper.map(result,shippingTaxApiMapper::toTaxRuleDto));
    }
