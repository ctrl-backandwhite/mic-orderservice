...
/**
 * Maps CJ Dropshipping order statuses to internal OrderStatus.
 * Reference: https://cjdropshipping.com/openapi/docs/order-status
 */
public enum CjOrderStatus {
    ...
    /**
     * Maps CJ status to the closest internal {@link OrderStatus}.
     * Returns null when no mapping is applicable.
     */
