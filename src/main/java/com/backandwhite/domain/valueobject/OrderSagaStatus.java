...
/**
 * Tracks the Saga compensation state for an order. Used in a choreography-based
 * Saga to ensure distributed consistency when payment or stock operations fail.
 */
