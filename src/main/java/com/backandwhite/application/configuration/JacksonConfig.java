...
/**
 * Exposes a Jackson 2.x {@link ObjectMapper} bean so that components using
 * the {@code com.fasterxml.jackson.databind.ObjectMapper} type can be
 * autowired. Spring Boot 4 auto-configures a
